...
**Daily Bias — check all three:**
- [ ] SPY vs 50 MA: Above (LONG) / Below (SHORT)
- [ ] QQQ/NQ vs 50 MA: Above (LONG) / Below (SHORT)
- [ ] IWM/RTY vs 50 MA: Above (LONG) / Below (SHORT)
- [ ] MA stack: 9 EMA ___ 20 MA ___ 50 MA (stacked bullish / bearish / mixed)
- [ ] All three indices agree on bias? Yes / No — if No, trade smaller or skip

**Key Levels — mark all on chart:**
- [ ] PDH: _______ PDL: _______ PDC: _______
- [ ] PWH: _______ PWL: _______
- [ ] Pre-market high: _______ Pre-market low: _______
- [ ] Nearest swing high: _______ Nearest swing low: _______

**News & Setup:**
- [ ] High-impact news before 11 AM? Yes (reduce size / skip) / No
- [ ] Instrument confirmed, liquidity acceptable, position size set

---

## 2. MARKET OPEN (9:30–9:45 AM)

- [ ] Do NOT trade first 5 minutes (9:30–9:35 AM) — observe only
...
## 3. ACTIVE SESSION RULES (9:30–11:00 AM)

**Non-Negotiables — affirm before first trade:**
- [ ] Trade ONLY 9:30–11:00 AM ET
- [ ] Trade ONLY in the direction of the daily bias
- [ ] No chasing price — wait for pullbacks and retests
- [ ] No moving stops against the position
...
**Session limits:**
- [ ] Max trades today: _____ — count used: _____
- [ ] Daily max loss hit? → STOP. Log off. Done for the day.

---

## 4. TRADE SETUP — PRE-ENTRY GATE (all must pass)
...
| 15m confirms direction & location? | Yes / No |
...
- [ ] (2) Price at key structural level (PDH/PDL/PWH/PWL/swing)
- [ ] (3) VWAP confirms direction
- [ ] (4) ORBT pattern confirms direction
- [ ] (5) MA stack (9 EMA / 20 MA / 50 MA) confirms direction

**Trade Ticket (fill before entry):**

| Field | Value |
|-------|-------|
| Direction | Long / Short |
| Entry | _______ |
| Stop (structural level) | _______ |
| Target 1 | _______ |
| Target 2 | _______ |
| R/R Ratio | ___:1 (min 1:2) |
| Trigger | _______ |
| Confluence count | ___ / 5 |
...
- [ ] Stop entered in platform at or before entry
- [ ] Stop will NOT be moved to a worse level

**Winner management:**
- [ ] At 1:1 R/R → take 50% off, move stop to breakeven
...
## 6. POST-SESSION DEBRIEF (After 11:00 AM)
...
## 7. SESSION NOTES (Quick Jot)

**Market character today:** ____________________________________________

**What worked:** _____________________________________________________

**What didn't / rule broken:** __________________________________________

**Emotion that showed up:** ___________________________________________

**Pattern noticed:** __________________________________________________

**Tomorrow's focus:** _________________________________________________

**Key levels to pre-mark tomorrow:** Support: _______ Resistance: _______
